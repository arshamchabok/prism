      ...
      {(view === 'input' || view === 'error') && (
        <div style={{ minHeight: '500vh', position: 'relative' }}>
          ...
          {p2 > 0 && (
            ...
            >
              <SpotlightCard className="fashion-spotlight-card" spotlightColor="rgba(34, 211, 238, 0.18)">
                {/* Cyan/teal color blobs */}
                <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0, overflow: 'hidden', borderRadius: '24px' }}>
                  <div style={{ position: 'absolute', top: '-20%', right: '-10%', width: '60%', height: '85%', background: 'radial-gradient(ellipse, rgba(34,211,238,0.08) 0%, transparent 60%)', borderRadius: '50%' }} />
                  <div style={{ position: 'absolute', bottom: '-15%', right: '-5%', width: '45%', height: '60%', background: 'radial-gradient(ellipse, rgba(6,182,212,0.06) 0%, transparent 60%)', borderRadius: '50%' }} />
